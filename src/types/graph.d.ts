...
export interface Mutation {
  ...
  CompletePhopneNumberVerification: CompletePhopneNumberVerificationResponse;
  EmailSignIn: EmailSignInResponse;
  EmailSignUp: EmailSignUpResponse;
  FacebookConnect: FacebookConnectResponse;
  ReportMovement: ReportMovementResponse;
  RequestEmailVerification: RequestEmailVerificationResponse;
  RequesrRide: RequestRideResponse;
...
export interface CompletePhopneNumberVerificationMutationArgs {
  phoneNumber: string;
  key: string;
}
...
export interface RequesrRideMutationArgs {
  pickUpAddress: string;
  pickUpLat: number;
  pickUpLng: number;
  dropOffAddress: string;
...
export interface CompletePhopneNumberVerificationResponse {
  ok: boolean;
  error: string | null;
  token: string | null;
}
